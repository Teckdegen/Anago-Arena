...
export default function CatchPage() {
  ...
  if (gameState === 'lobby') return (
    <>
      <Head><title>Bone Catch – ANAGO ARENA</title></Head>
      <GameLobby gameId="catch" gameName="Bone Catch" gameEmoji="🦴" accentColor="#E8A020"
  ...
  if (gameState === 'playing') return (
    <>
      ...
      <div className="fixed top-0 left-0 right-0 z-10 flex justify-between items-center p-3 pointer-events-none">
        <div className="hud-panel"><p className="hud-score" style={{ color: '#E8A020' }}>{user?.username || 'YOU'}: {scores[0]}</p></div>
