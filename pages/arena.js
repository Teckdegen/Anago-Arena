...
const GAMES = [
  {
    ...
    name: 'BasketBattle',
    emoji: '🏀',
    desc: 'Side-view 1v1. Jump, shoot into the hoop. Button controls. First to 7 wins!',
  ...
  },
  {
    ...
    name: 'Dog Tennis',
    emoji: '🎾',
    desc: 'Perspective court. Move, swing & lob. Real tennis scoring. Best of 3 sets!',
    color: '#E8A020', shadow: '#9A6010', accent: 'rgba(232,160,32,0.2)',
    route: '/games/tennis', tag: 'NEW', tagColor: '#E8A020',
    features: ['VS AI', 'PVP'],
  },
]
