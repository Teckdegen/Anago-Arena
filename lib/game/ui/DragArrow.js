export class DragArrow {
  ...
  _build() {
    ...
    // ── Arrowhead — big solid filled triangle ─────────
    const headGeo = new T.ConeGeometry(0.38, 0.85, 8)
    ...
    // Thick black outline on arrowhead
    const outlineGeo = new T.ConeGeometry(0.42, 0.90, 8)
