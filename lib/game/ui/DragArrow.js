export class DragArrow {
  ...
  _build() {
    ...
    // Use a cone/triangle mesh for a big visible arrowhead
    const headGeo = new T.ConeGeometry(0.22, 0.55, 8)
    ...
    // Outline on arrowhead
    const outlineGeo = new T.ConeGeometry(0.24, 0.57, 8)
