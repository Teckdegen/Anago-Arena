export class GameScene {
  ...
  _buildBackground() {
    ...
    this._bgMesh.position.set(0, 4, -5)
  ...
  _buildHills() {
    ...
    const hillData = [
      { x: -5,  y: 1.2, z: -3.8, rx: 3.5, ry: 1.4 },
      { x:  0,  y: 1.0, z: -3.8, rx: 4.0, ry: 1.2 },
      { x:  5,  y: 1.3, z: -3.8, rx: 3.2, ry: 1.3 },
      { x: -8,  y: 0.9, z: -3.6, rx: 2.8, ry: 1.0 },
      { x:  8,  y: 1.1, z: -3.6, rx: 3.0, ry: 1.1 },
    ]
  ...
  _buildClouds() {
    ...
    const cloudGroups = [
      { cx: -6,  cy: 8.5, z: -3.5, speed: 0.28 },
      { cx:  1,  cy: 9.2, z: -3.5, speed: 0.22 },
      { cx:  6,  cy: 8.0, z: -3.5, speed: 0.32 },
      { cx: -1,  cy: 8.8, z: -3.5, speed: 0.18 },
    ]
